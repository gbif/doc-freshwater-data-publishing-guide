...
[cols="34,33,33"]
|===
.2+|Freshwater data categories 2+|GBIF data class |Occurrence data |Sampling-event data
...
| term:dwc[dataLanguage]
|language in which the data are provided
|`English`, `German`
|required
|

| term:dwc[publishingOrganization]
