...
[[table-03]]
.Terms with freshwater-specific definitions, examples and comments for the metadata fields required by GBIF (https://ipt.gbif.org/manual/en/ipt/latest/gbif-metadata-profile#validation-of-metadata[more information^])
[cols="18,25,25,12,~"]
|===
