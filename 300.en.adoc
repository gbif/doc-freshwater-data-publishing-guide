...
typeoOfObservation:: _definition_: category of occurrence and sampling-event data based on the type of observation recorded +
...
samplingEquipment:: _definition_: name or description of the sampling instrument that was used for collecting the taxa, including mesh sizes where applicable +
