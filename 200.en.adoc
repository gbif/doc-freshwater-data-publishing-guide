...
[[table-04]]
.Freshwater-specific terms, definitions, examples, and comments required or recommended for publishing checklist datasets to GBIF (see https://www.gbif.org/data-quality-requirements-checklists[more information^] on the specific fields).
[cols="%autowidth"]
|===
...
[[table-05]]
.Freshwater-specific terms, definitions, examples, and comments required or recommended for publishing occurrence datasets to GBIF (https://www.gbif.org/data-quality-requirements-occurrences[more information^] on specific fields)
[cols="%autowidth"]
|===
...
[[table-06]]
.Freshwater specific terms, definitions, examples, and comments  required or recommended for publishing sampling-event datasets to GBIF (https://www.gbif.org/data-quality-requirements-sampling-events[more information^] on the specific fields)
[cols="%autowidth"]
|===
|Term	|Freshwater definition |Example |Status |Comment
