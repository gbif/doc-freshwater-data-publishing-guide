...
[[table-04]]
.Freshwater-specific terms, definitions, examples, and comments for the terms required or recommended for publishing checklist datasets to GBIF (see https://www.gbif.org/data-quality-requirements-checklists[more information^] on the specific fields).
[cols="%autowidth"]
|===
