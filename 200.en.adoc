...
|Share, if available (based on link:https://rs.tdwg.org/dwc/terms/identificationVerificationStatus[identification{zwsp}Verification{zwsp}Status,role="termy"] dwc[identificationVerificationStatus])
