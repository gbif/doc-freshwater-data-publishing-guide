...
|link:https://rs.tdwg.org/dwc/terms/minimumDepthInMeters[`minimumDept{zwsp}InMeters`,role="term"]
...
|link:https://rs.tdwg.org/dwc/terms/maximumDepthInMeters[`maximumDept{zwsp}InMeters`,role="term"]
