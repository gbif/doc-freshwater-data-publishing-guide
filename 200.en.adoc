...
Current extensions do not have fields that correspond to the freshwater data categories (<<Freshwater data categories,§1.2.2>>), neither the type of observation nor type of contribution. This information can be captured in the dynamic properties field until specific fields are created. 
